    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('cost', models.SmallIntegerField(verbose_name='Добавочная стоимость')),
            ],
        ),
        migrations.CreateModel(
            name='Customer',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('num', models.SmallIntegerField(unique=True, verbose_name='Количество')),
                ('cost', models.SmallIntegerField(verbose_name='Добавочная стоимость')),
            ],
        ),
        migrations.CreateModel(
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('source', models.CharField(max_length=100, verbose_name='Which site sent the traffic')),
                ('medium', models.CharField(max_length=100, verbose_name='Type of link')),
                ('campaign', models.CharField(max_length=100, verbose_name='Аdvertising company')),
                ('content', models.CharField(default=None, max_length=100, null=True, verbose_name='Content')),
                ('term', models.CharField(default=None, max_length=100, null=True, verbose_name='Searching terms')),
            ],
        ),
        migrations.CreateModel(
            name='Order',
            fields=[
                ...
                ('berries', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.PROTECT, related_name='orders', to='cake_designer.berry', verbose_name='Ягоды')),
                ...
                ('decoration', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.PROTECT, related_name='orders', to='cake_designer.decoration', verbose_name='Декор')),
                ('delivery', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='customer', to='cake_designer.delivery', verbose_name='Параметры доставки')),
                ...
                ('utm', models.ForeignKey(default=None, null=True, on_delete=django.db.models.deletion.PROTECT, related_name='orders', to='cake_designer.utm', verbose_name='UTM')),
            ],
        ),
    ]
